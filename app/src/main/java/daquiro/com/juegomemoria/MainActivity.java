package daquiro.com.juegomemoria;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Cambio del color del segundo jugador que está inactivo.
    ...
    private void doStuff(ImageView iv, int card) {
        //seleccionar la imagen correcta en el imagenView
        ...
        if (cardNumber == 1) {
            firsCard = cardsArray[card];
            if (firsCard > 200) {
                firsCard = firsCard - 100;
            }
            cardNumber = 2;
            clickedFirst = card;
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //verificar si las imagenes seleccionadas son las mismas
                    calculate();
                }
            }, 1000);
    ...
    private void calculate() {
        if (firsCard == secondCard) {
            ...
            //sumarle los puntos al jugador correcto
            if (turn == 1) {
                playerPoints++;
